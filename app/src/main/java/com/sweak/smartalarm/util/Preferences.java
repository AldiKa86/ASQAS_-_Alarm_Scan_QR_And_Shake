...
public class Preferences {
    ...
    private static final String PREFERENCES_SHAKE_COUNT_KEY = "shakeCount";
    ...
    public void setShakeCount(int shakeCount) {
        mPreferencesEditor = mSharedPreferences.edit();
        mPreferencesEditor.putInt(PREFERENCES_SHAKE_COUNT_KEY, shakeCount);
        mPreferencesEditor.apply();
    }

    public int getShakeCount() {
        return mSharedPreferences.getInt(PREFERENCES_SHAKE_COUNT_KEY, 10);
    }
